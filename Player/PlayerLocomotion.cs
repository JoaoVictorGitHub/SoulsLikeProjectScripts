...
public class PlayerLocomotion : MonoBehaviour
{
    ...
    void Start()
    {
        uIStopTime = FindObjectOfType<UIStopTime>();
    ...
    public void HandleRollingAndSprinting(float delta)
    {
        ...
        if (inputHandler.rollFlag && playerStats.currentStamina > 0)
        {
            ...
            {
                animatorHandler.PlayTargetAnimation("P_Roll", true);
                moveDirection.y = 0;
            ...
            {
                animatorHandler.PlayTargetAnimation("P_Stepback", true);
            }
        }
    }
    ...
    public void HandleFalling(float delta, Vector3 moveDirection)
    {
        ...
        if(Physics.Raycast(origin, -Vector3.up, out hit, minimumDistanceNeededToBeginFall, ignoreForGroundCheck))
        {
            ...
            if (playerManager.isInAir)
            {
                if(inAirTimer > 0.5f)
                {
                    ...
                    animatorHandler.PlayTargetAnimation("P_Land", true);
                    inAirTimer = 0;
                }
                else
                {
        ...
        else
        {
            ...
            if(playerManager.isInAir == false)
            {
                ...
                {
                    animatorHandler.PlayTargetAnimation("P_Fall", true);
                }
    ...
    public void HandleJumping()
    {
        ...
        if (inputHandler.jump_Input)
        {
            if(inputHandler.moveAmount > 0)
            {
                moveDirection = cameraObject.forward * inputHandler.vertical;
                moveDirection += cameraObject.right * inputHandler.horizontal;
                animatorHandler.PlayTargetAnimation("P_Jump", true);
                moveDirection.y = 0;
