...
public class CameraHandler : MonoBehaviour
{
    ...
    public float lockedPivodPosition = 2.25f;
    ...
    public void HandleLockOn()
    {
        ...
        for (int k = 0; k < availableTargets.Count; k++)
        {
            ...
            if (inputHandler.lockOnFlag)
            {
                ...
                var distanceFromRightTarget = currentLockOnTarget.position.x + availableTargets[k].transform.position.x;
    ...
    public void SetCameraHeight()
    {
        ...
        Vector3 newLockedPosition = new Vector3(0, lockedPivodPosition);
